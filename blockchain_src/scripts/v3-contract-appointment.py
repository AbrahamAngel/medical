...
def interact_with_appointment_contract(contract_address, contract_abi):
    """
    ...
    patientName = "Alex Fraser"
    doctorName = "Dr.Jane Smith"
    appointmentDate = 1640000000  # Example timestamp (January 1, 2022)
